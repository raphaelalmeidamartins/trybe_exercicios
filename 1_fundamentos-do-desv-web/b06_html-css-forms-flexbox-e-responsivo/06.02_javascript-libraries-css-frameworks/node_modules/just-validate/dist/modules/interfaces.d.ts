...
export interface FieldRuleInterface {
    rule?: Rules;
    errorMessage?: string;
    validator?: (value: string | boolean, context: FieldsInterface) => ValidatorReturn;
...
export interface FieldConfigInterface extends Partial<Pick<GlobalConfigInterface, 'errorFieldStyle' | 'errorFieldCssClass' | 'errorLabelStyle' | 'errorLabelCssClass' | 'tooltip'>> {
}
